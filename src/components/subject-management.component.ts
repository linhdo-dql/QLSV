          ...
          <tr class="hover:bg-slate-700/40 transition-colors duration-200">
            ...
            <td class="py-4 px-6">
              <div class="flex items-center gap-4">
                ...
                <button (click)="openDeleteConfirm(mh)" class="text-slate-400 hover:text-rose-500 transition-colors duration-200">
...
export class SubjectManagementComponent {
    ...
    confirmDelete(): void {
      ...
      if (subject) {
        this.dataService.deleteMonHoc(subject.maMonHoc);
      }
